...
if not os.path.exists(FONT_PATH):
    st.warning(
        f"⚠️ Chinese font not found at `{FONT_PATH}`.\n"
        f"Please add `NotoSansTC-Regular.otf` to the `fonts/` folder in your repo "
        f"to enable Chinese PDF/chart output."
    )
    ...
    st.session_state.chat = [
        {"role": "system", "content":
         ("You are a helpful data analyst.\n"
          ...
          "- For Chinese charts call enable_matplotlib_chinese() first.\n"
          "- For PDFs with Chinese text, always create via make_unicode_pdf().\n"
