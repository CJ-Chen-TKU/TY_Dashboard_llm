...
# Initialize font once at startup
ensure_font()                                   # verifies file exists and size
FONT_OK = enable_matplotlib_chinese(FONT_PATH)  # set global matplotlib rcParams
fp = get_tc_fontprops()                         # ready-to-use FontProperties
