...
if ask_clicked:
    if not user_q.strip():
        ...
        if "```python" in reply.lower():
            ...
            # Ensure fpdf2 is available to export PDF (no filesystem writes).
            try:
                import importlib
...
if st.session_state.chat and st.session_state.chat[-1]["role"] == "assistant":
    ...
    if code_match:
        ...
        try:
            ...
            # Install once if missing (no sidebar toggle needed)
