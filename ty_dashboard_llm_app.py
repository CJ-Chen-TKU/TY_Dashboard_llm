...
# Azure AD / AAD app
CLIENT_ID     = st.sidebar.text_input("Azure Client ID", value="eaa575b7-b4d6-48f2-8451-c4d0fe3c2ad4")
TENANT_ID     = st.sidebar.text_input("Azure Tenant ID", value="fd9290f7-a3a2-4d0b-ac94-3a6e1896526e")
