...
# Filter to only those tables that exist in the model
#table_names = sorted([t for t in tables_dict.keys() if t in allowed_tables])

#if not table_names:
#    st.error("No matching tables found. Check Fabric permissions or table names.")
#    st.stop()
